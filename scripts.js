...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById("loadGPXFile-form").addEventListener('submit', function(e){
        ...
        reader.onload = function(event) {
            ...
            console.log(gpx.routes[0].points[0]);


            //create route:
            var listOfPoints = [];
            var length = gpx.routes[0].points.length;
            var sumA = 0;
            var sumB = 0;
            ...
            var pred = gpx.routes[0].points[0];
            for (var i = 1; i < length; i++){
                  console.log(pred);
                  var buffer = gpx.routes[0].points[i];
                ...
                var endTime = listOfDates[length-1];
                ...
                document.getElementById("distancePH").innerHTML = (gpx.routes[0].distance.total/1000).toFixed(2) + " km";
